...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/HdmovieeProviderbot')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/BhootBazar')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/HdDMovieProviderBot')
...
URL = "https://ultasuperfasthe-7424e27781c0.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://ultasuperfasthe-7424e27781c0.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://ultasuperfasthe-7424e27781c0.herokuapp.com/".format(FQDN)
else:
    URL = "https://ultasuperfasthe-7424e27781c0.herokuapp.com/".format(FQDN)
